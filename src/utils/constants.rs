...
pub const BRAAVOS_BASE_ACCOUNT_SIERRA_PATH: &str = "src/contracts/BraavosBaseAccount.sierra.json";
pub const BRAAVOS_BASE_ACCOUNT_CASM_PATH: &str = "src/contracts/BraavosBaseAccount.casm.json";
