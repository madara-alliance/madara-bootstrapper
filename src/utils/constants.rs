...
pub const L2_ETH_BRIDGE_SIERRA_PATH: &str = "artifacts/token_bridge.sierra.json";
pub const L2_ETH_BRIDGE_CASM_PATH: &str = "artifacts/token_bridge.casm.json";
pub const L2_ETH_BRIDGE_EIC_SIERRA_PATH: &str = "artifacts/token_bridge_eic.sierra.json";
pub const L2_ETH_BRIDGE_EIC_CASM_PATH: &str = "artifacts/token_bridge_eic.casm.json";
...
pub const EIC_ETH_TOKEN_SIERRA_PATH: &str = "src/upgrade-artifacts/eic_eth_token.sierra.json";
pub const EIC_ETH_TOKEN_CASM_PATH: &str = "src/upgrade-artifacts/eic_eth_token.casm.json";
pub const NEW_ETH_TOKEN_SIERRA_PATH: &str = "src/upgrade-artifacts/new_eth_token.sierra.json";
pub const NEW_ETH_TOKEN_CASM_PATH: &str = "src/upgrade-artifacts/new_eth_token.casm.json";
pub const EIC_ETH_BRIDGE_SIERRA_PATH: &str = "src/upgrade-artifacts/eic_eth_bridge.sierra.json";
pub const EIC_ETH_BRIDGE_CASM_PATH: &str = "src/upgrade-artifacts/eic_eth_bridge.casm.json";
pub const NEW_ETH_BRIDGE_SIERRA_PATH: &str = "src/upgrade-artifacts/new_eth_bridge.sierra.json";
pub const NEW_ETH_BRIDGE_CASM_PATH: &str = "src/upgrade-artifacts/new_eth_bridge.casm.json";
// Other
