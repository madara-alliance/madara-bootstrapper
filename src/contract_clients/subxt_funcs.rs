...
// pub async fn declare_contract_subxt(declare_txn: DeclareTransaction) -> Result<(), Box<dyn
// std::error::Error>> {     let api = OnlineClient::<SubstrateConfig>::new().await.unwrap();
...
//         tx:
// appchain::runtime_types::starknet_api::transaction::DeclareTransaction::V0(DeclareTransactionV0V1
// {             max_fee: Fee(0u128),
...
//             sender_address:
// ContractAddress(appchain::runtime_types::starknet_api::core::PatriciaKey(StarkFelt(
...
//                 0: ContractClassV0Inner { program: artifact_program, entry_points_by_type:
// entrypoints_artifact },             }),
